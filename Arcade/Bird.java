...
public class Bird
{
    ...
    public Bird(FloppyGame myGame)
    {
        ...
        sprites.add(new ImageIcon("Assets/FlappyBird/bluebird-downflap.png").getImage());
        sprites.add(new ImageIcon("Assets/FlappyBird/bluebird-midflap.png").getImage());
        sprites.add(new ImageIcon("Assets/FlappyBird/bluebird-upflap.png").getImage());
        flap();
        fall();
    }
