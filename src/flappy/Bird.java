...
public class Bird {
    ...
    public Bird(FloppyGame myGame) {
        ...
        sprites.add(new ImageIcon("assets/flappy/bluebird-downflap.png").getImage());
        sprites.add(new ImageIcon("assets/flappy/bluebird-midflap.png").getImage());
        sprites.add(new ImageIcon("assets/flappy/bluebird-upflap.png").getImage());
        flap();
        fall();
    }
