...
public class Pacman extends BoardPlayer {
    ...
    protected void loadSprites() {
        ...
        for (String dir : dirs)
            for (int i = 1; i <= 2; i++) {
                sprites[ind] = new ImageIcon("assets/pacman/pac/pac" + dir + i + ".png").getImage();
                ind++;
            }
        sprites[ind] = new ImageIcon("assets/pacman/pac/pac.png").getImage();
        ind++;
        for (int i = 0; i <= 10; i++) {
            sprites[ind] = new ImageIcon("assets/pacman/pac/death" + i + ".png").getImage();
            ind++;
        }
    }
