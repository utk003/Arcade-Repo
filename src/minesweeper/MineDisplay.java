...
public class MineDisplay extends JComponent implements KeyListener, MouseListener {
    ...
    private static final Image redFlag = new ImageIcon("assets/minesweeper/art/flag-red.png").getImage();
    private static final Image grayFlag = new ImageIcon("assets/minesweeper/art/flag-gray.png").getImage();
    private static final Image mine = new ImageIcon("assets/minesweeper/art/exploded.png").getImage();
    private static final Image redX = new ImageIcon("assets/minesweeper/art/x-red.png").getImage();
    private static final Image flower = new ImageIcon("assets/minesweeper/art/flower.png").getImage();
    private static final Image stopwatch = new ImageIcon("assets/minesweeper/art/stopwatch.png").getImage();
    private static final Image highscore = new ImageIcon("assets/minesweeper/art/highscore.png").getImage();
