...
public class MineDisplay extends JComponent implements KeyListener, MouseListener
{
    ...
    private static final Image redFlag = new ImageIcon("Assets/flag-red.png").getImage();
    private static final Image grayFlag = new ImageIcon("Assets/flag-gray.png").getImage();
    private static final Image mine = new ImageIcon("Assets/exploded.png").getImage();
    private static final Image redX = new ImageIcon("Assets/x-red.png").getImage();
    private static final Image flower = new ImageIcon("Assets/flower.png").getImage();
    private static final Image stopwatch = new ImageIcon("Assets/stopwatch.png").getImage();
    private static final Image highscore = new ImageIcon("Assets/highscore.png").getImage();
